...
from tap_medusa_v2.client import MedusaStream
...
class OrdersStream(MedusaStream):
    ...
    additional_params = {
        "fields": "id,updated_at,status,fulfillment_status,payment_status,display_id,cart_id,customer_id,email,region_id,currency_code,tax_rate,draft_order_id,canceled_at,no_notification,sales_channel_id,metadata,external_id,summary,shipping_address,billing_address,payment_collection,shipping_methods,fulfillments,items,customer,transactions,edits,claims,swaps,returns,discounts,gift_cards,region,sales_channel"
    }
    ...
    schema = th.PropertiesList(
        ...
        th.Property("payment_collection", payment_collection),
